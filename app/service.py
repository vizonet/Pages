...
class ContentType(models.Model):
    ...
    # Словарь стороковых представлений связанных объектов контента по типу
    CTYPE_DICT_STR = {
...
# ----- Общие функционал, в т.ч. для расширения стандартных методов моделей
...
def save_type_content(obj, content_model, *args, **kwargs):
    ...
    # Проверка и удаление на дубликатов
    ...
    if hash_query is not None and hash_query.exists():
        ...
        # Перепривязка объектов контента на первый в истории дубликатов
