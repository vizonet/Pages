...
# ----- Constants
CAPITALIZE_LANG_CODES = ('en-us',)  # кортеж языков для капитализации всех слов строки
...
class Page(Title):
    """ Страница с контентом. Наследует модель Title. """
...
class Audio(Properties):
    """ Модель медиаконтента. Файл изображения. """
...
class Video(Properties):
    """ Модель медиаконтента. Файл документа, аудио, видео и др. """
